...
\book {
  ...
  \score {
    \new StaffGroup <<
      ...
      \new Staff \with {
        instrumentName = "Small Group Top"
        shortInstrumentName = "SG Top"
      } <<
        \new Voice = "sgTop" {
          \sgTopMusic
        }
      >>
      \new Staff \with {
        instrumentName = "Small Group Middle"
        shortInstrumentName = "SG Mid"
      } <<
        \new Voice = "sgMid" {
          \sgMidMusic
        }
      >>
      \new Staff \with {
        instrumentName = "Small Group Bottom"
        shortInstrumentName = "SG Bot"
      } <<
        \new Voice = "sgBot" {
          \sgBotMusic
        }
